...
class AndroidMkWriter(object):
  ...
  def Write(self, qualified_target, relative_target, base_path, output_filename,
    ...
    self.android_class = MODULE_CLASSES.get(self.section, 'GYP')
  ...
  def ComputeAndroidModule(self, spec):
    ...
    if int(spec.get('android_unmangled_name', 0)):
      assert self.section != 'shared_library' or self.target.startswith('lib')
      return self.target
  ...
  def ComputeOutputParts(self, spec):
    ...
    """
    assert self.section != 'loadable_module' # TODO: not supported?
    ...
    if self.section != 'static_library' and self.section != 'shared_library':
  ...
  def WriteTarget(self, spec, configs, deps, link_deps, part_of_all,
    ...
    # Add the command to trigger build of the target section depending
